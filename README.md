# Chrome extension "Canvas downloader. Find and export."  
...
Page for testing the extension using multiple canvas elements [here](https://santriseus.github.io/canvas-downloader/)  
